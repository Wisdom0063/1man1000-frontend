      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <textarea
                id="description"
                placeholder="Describe your campaign goals, requirements, and any special instructions for influencers..."
                {...register("description")}
                className="flex min-h-[120px] w-full rounded-xl border border-border/60 bg-background px-4 py-3 text-sm shadow-sm transition-all placeholder:text-muted-foreground/70 hover:border-border focus-visible:border-primary focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-primary/20"
              />
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="targetAudience"
                  placeholder="e.g., Young adults 18-35 in Ghana"
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Set your campaign budget and target views
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="space-y-2">
                <Label htmlFor="targetViewRange.min">
                  Min Views <span className="text-destructive">*</span>
                </Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="targetViewRange.max">
                  Max Views <span className="text-destructive">*</span>
                </Label>
                <Input
            ...
            <div className="rounded-xl bg-muted/50 p-4 flex items-start gap-3">
              ...
              <div className="text-sm">
                ...
                <p className="text-muted-foreground">
                  With a budget of GH₵{estimatedCost.toLocaleString()}, you can
                  reach approximately {targetMax?.toLocaleString() || 0} views
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>When should your campaign run?</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
        ...
        <div className="flex items-center justify-end gap-4 pt-4">
          <Button type="button" variant="outline" asChild>
            <Link href="/client/campaigns">Cancel</Link>
          </Button>
        ...
        {createMutation.isError && (
          <div className="rounded-xl bg-destructive/10 border border-destructive/20 p-4 text-center">
            <p className="text-sm text-destructive">
              Failed to create campaign. Please check your details and try
              again.
            </p>
          </div>
        )}
